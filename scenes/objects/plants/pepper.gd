...
var pepper_harvest_scene = preload("res://scenes/objects/plants/pepper_harvest.tscn")
...
func on_crop_harvesting() -> void:
	var pepper_harvest_instance = pepper_harvest_scene.instantiate() as Node2D
	pepper_harvest_instance.global_position = global_position
	print("spawning at: ", global_position)
	print("parent: ", get_parent())
	get_parent().add_child(pepper_harvest_instance)
	queue_free()
